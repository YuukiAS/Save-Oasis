...
var $author$project$Model$Keys = F2(
	function (left, right) {
		return {left: left, right: right};
	});
var $author$project$Model$nokeys = A2($author$project$Model$Keys, false, false);
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$Model$initial = function (_v0) {
		...
		_List_fromArray(
			[
				...
				A2(
					...
					A2($elm$json$Json$Decode$field, 'key', $elm$json$Json$Decode$string))),
				$elm$browser$Browser$Events$onAnimationFrameDelta($author$project$Message$TimeDelta)
			]));
};
...
var $author$project$Calculate$leftCoordinate = function (model) {
	return _Utils_Tuple2(
		...
		$elm$core$Basics$floor(((model.ball_x - $author$project$Calculate$r) - 8) / 6.675));
};
...
var $author$project$Calculate$upCoordinate = function (model) {
	return _Utils_Tuple2(
		$elm$core$Basics$floor(((model.ball_y - $author$project$Calculate$r) - 8) / 2.675),
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 'TimeDelta':
				var dt = msg.a;
				return _Utils_Tuple2(
					A2($author$project$Update$updateTime, model, 0.1),
					$elm$core$Platform$Cmd$none);
			default:
...
var $author$project$Color$cus_yellow = '#feca57';
var $elm$svg$Svg$Attributes$cx = _VirtualDom_attribute('cx');
var $elm$svg$Svg$Attributes$cy = _VirtualDom_attribute('cy');
var $elm$svg$Svg$Attributes$fill = _VirtualDom_attribute('fill');
var $elm$core$String$fromFloat = _String_fromNumber;
var $elm$svg$Svg$Attributes$r = _VirtualDom_attribute('r');
var $author$project$Object$renderBall = function (point) {
	return A2(
		$elm$svg$Svg$circle,
		_List_fromArray(
			[
				...
				$elm$svg$Svg$Attributes$fill($author$project$Color$cus_yellow)
			]),
		_List_Nil);
};
var $author$project$Color$cus_orange = '#ff9f43';
var $elm$svg$Svg$Attributes$height = _VirtualDom_attribute('height');
var $elm$svg$Svg$rect = $elm$svg$Svg$trustedNode('rect');
var $elm$svg$Svg$Attributes$width = _VirtualDom_attribute('width');
var $elm$svg$Svg$Attributes$x = _VirtualDom_attribute('x');
var $elm$svg$Svg$Attributes$y = _VirtualDom_attribute('y');
var $author$project$Object$renderPaddle = F3(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					$elm$svg$Svg$Attributes$fill($author$project$Color$cus_orange)
				]),
			_List_Nil);
	});
var $author$project$Color$cus_purple = '#5f27cd';
...
var $author$project$Object$renderPillar = F2(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					$elm$core$String$fromFloat(pointA.x) + '%'),
					$elm$svg$Svg$Attributes$y1(
					$elm$core$String$fromFloat(pointA.y) + '%'),
					$elm$svg$Svg$Attributes$x2(
					$elm$core$String$fromFloat(pointB.x) + '%'),
					$elm$svg$Svg$Attributes$y2(
					$elm$core$String$fromFloat(pointB.y) + '%'),
					$elm$svg$Svg$Attributes$stroke($author$project$Color$cus_purple),
					$elm$svg$Svg$Attributes$strokeWidth('0.1%')
				]),
			_List_Nil);
	});
var $author$project$Color$cus_blue = '#54a0ff';
var $author$project$Object$renderBlueBrick = F5(
	function (num1, num2, point, wid, hei) {
		var c = $author$project$Color$cus_blue;
...
var $author$project$Color$cus_cyan = '#00d2d3';
var $author$project$Object$renderCyanBrick = F5(
	function (num1, num2, point, wid, hei) {
		var c = $author$project$Color$cus_cyan;
		var b = point.y + ((hei + 0.175) * num2);
		var a = point.x + ((wid + 0.175) * num1);
		return A2(
			$elm$svg$Svg$rect,
...
var $author$project$Object$renderABrick = F5(
	function (model, a, point, wid, hei) {
		return (A2($elm$core$List$member, a, model.cyanBricks) && (!A2($elm$core$List$member, a, model.emptyBricks))) ? _List_fromArray(
			...
			]) : (((!A2($elm$core$List$member, a, model.cyanBricks)) && (!A2($elm$core$List$member, a, model.emptyBricks))) ? _List_fromArray(
			[
				...
				A2(
					...
					_List_fromArray(
						[
							...
							A2(
							$author$project$Object$renderPillar,
							A2($author$project$Model$Point, 10, 8),
							A2($author$project$Model$Point, 90, 8)),
							A2(
							$author$project$Object$renderPillar,
							A2($author$project$Model$Point, 10, 45),
							A2($author$project$Model$Point, 90, 45)),
							A2(
							$author$project$Object$renderPillar,
							A2($author$project$Model$Point, 10, 8),
							A2($author$project$Model$Point, 10, 45)),
