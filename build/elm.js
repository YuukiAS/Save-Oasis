									...
									return function (seven) {
										return function (eight) {
											return function (nine) {
												return function (ten) {
													return {eight: eight, enter: enter, five: five, four: four, left: left, nine: nine, one: one, right: right, seven: seven, six: six, ten: ten, three: three, two: two};
												};
											};
										};
									};
...
var $author$project$Model$nokeys = $author$project$Model$Keys(false)(false)(false)(false)(false)(false)(false)(false)(false)(false)(false)(false)(false);
		...
		return _Utils_Tuple2(
			{
				...
				combo: 0,
				cyanBricks: _List_Nil,
				difficulty: $author$project$Outlooks$Normal,
				emptyBricks: _List_Nil,
				exp: 0,
				key: key,
...
var $author$project$Update$brickGenerator = A2(
	...
	_Utils_Tuple2(85, $author$project$Outlooks$Cyan),
	_List_fromArray(
		[
			_Utils_Tuple2(5, $author$project$Outlooks$Red),
			_Utils_Tuple2(10, $author$project$Outlooks$Pink)
		]));
...
var $author$project$Check$cClearLine = F2(
	function (model, num) {
		return (A2(
			$elm$core$List$member,
			_Utils_Tuple2(num, 0),
			model.emptyBricks) && (A2(
			$elm$core$List$member,
			_Utils_Tuple2(num, 1),
			model.emptyBricks) && (A2(
			$elm$core$List$member,
			...
			model.emptyBricks) && (A2(
			$elm$core$List$member,
			_Utils_Tuple2(num, 10),
			model.emptyBricks) && A2(
			$elm$core$List$member,
			_Utils_Tuple2(num, 11),
			model.emptyBricks)))))))))))) ? 1 : 0;
	});
var $elm$core$Basics$ge = _Utils_ge;
var $author$project$Object$r = 1;
var $author$project$Check$cDownPaddle = function (model) {
	return (((_Utils_cmp(model.ball_x, model.pad_x) > -1) && (_Utils_cmp(model.ball_x, model.pad_x + 12) < 1)) && (((model.ball_y + $author$project$Object$r) > 40) && ((model.ball_y + $author$project$Object$r) <= 40.5))) ? true : false;
};
var $author$project$Check$cGameOver = function (model) {
	return ((((model.ball_x + $author$project$Object$r) <= 90) && ((model.ball_x - $author$project$Object$r) >= 10)) && ((model.ball_y + $author$project$Object$r) >= 45)) ? true : false;
};
var $author$project$Calculate$leftCoordinate = function (model) {
	return _Utils_Tuple2(
		$elm$core$Basics$floor((model.ball_y - 8) / 2.675),
		$elm$core$Basics$floor(((model.ball_x - $author$project$Object$r) - 8) / 6.675));
};
var $elm$core$Basics$round = _Basics_round;
var $author$project$Check$cLeftBricks = function (model) {
	return ((_Utils_cmp(
		((model.ball_x - $author$project$Object$r) - 16.5) / 6.675,
		$elm$core$Basics$round(((model.ball_x - $author$project$Object$r) - 16.5) / 6.675)) < 0) && ((((model.ball_y - $author$project$Object$r) > 8) && (model.ball_y < 21.2)) && (!A2(
		$elm$core$List$member,
...
var $author$project$Check$cLeftPillar = function (model) {
	return (((model.ball_y + $author$project$Object$r) < 45) && (((model.ball_y - $author$project$Object$r) > 8) && ((model.ball_x - $author$project$Object$r) <= 10))) ? true : false;
};
...
var $author$project$Check$cRightBricks = function (model) {
	return (((((model.ball_x + $author$project$Object$r) - 10) / 6.675) <= 11) && (((((model.ball_x + $author$project$Object$r) - 10) / 6.675) >= 0) && ((_Utils_cmp(
		((model.ball_x + $author$project$Object$r) - 10) / 6.675,
		$elm$core$Basics$round(((model.ball_x + $author$project$Object$r) - 10) / 6.675)) > 0) && ((((model.ball_y - $author$project$Object$r) > 8) && (model.ball_y < 21.2)) && (!A2(
		$elm$core$List$member,
		$author$project$Calculate$rightCoordinate(model),
		model.emptyBricks)))))) ? true : false;
};
var $author$project$Check$cRightPillar = function (model) {
	return (((model.ball_y + $author$project$Object$r) < 45) && (((model.ball_y - $author$project$Object$r) > 8) && ((model.ball_x + $author$project$Object$r) >= 90))) ? true : false;
};
var $author$project$Calculate$upCoordinate = function (model) {
	return _Utils_Tuple2(
		$elm$core$Basics$floor(((model.ball_y - $author$project$Object$r) - 8) / 2.675),
		$elm$core$Basics$floor((model.ball_x - 10) / 6.675));
};
var $author$project$Check$cUpBricks = function (model) {
	return ((_Utils_cmp(
		((model.ball_y - $author$project$Object$r) - 10.5) / 2.675,
		$elm$core$Basics$round(((model.ball_y - $author$project$Object$r) - 10.5) / 2.675)) < 0) && ((((model.ball_y - $author$project$Object$r) > 8) && ((model.ball_y - $author$project$Object$r) < 21.2)) && (!A2(
		$elm$core$List$member,
		$author$project$Calculate$upCoordinate(model),
		model.emptyBricks)))) ? true : false;
};
var $author$project$Check$cUpPillar = function (model) {
	return ((((model.ball_x + $author$project$Object$r) <= 90) && ((model.ball_x - $author$project$Object$r) >= 10)) && ((model.ball_y - $author$project$Object$r) <= 8)) ? true : false;
};
var $author$project$Check$cWin = function (model) {
	return (A2(
		$elm$core$List$member,
		_Utils_Tuple2(0, 0),
		model.emptyBricks) && (A2(
...
var $author$project$Update$updateTime = F2(
	function (model, dt) {
		...
		var ski_9_eff = (_Utils_eq(
			A2($elm_community$list_extra$List$Extra$getAt, 8, model.skills_ok),
			$elm$core$Maybe$Just(true)) && ((model.second === 10) || ((model.second === 20) || (model.second === 40)))) ? true : false;
		var ski_8_eff = _Utils_eq(
			A2($elm_community$list_extra$List$Extra$getAt, 7, model.skills_ok),
			$elm$core$Maybe$Just(true)) ? true : false;
		var ski_7_eff = (_Utils_eq(
			A2($elm_community$list_extra$List$Extra$getAt, 6, model.skills_ok),
			$elm$core$Maybe$Just(true)) && ((!model.second) || (model.second === 30))) ? true : false;
		...
		var ski_5_eff = _Utils_eq(
			A2($elm_community$list_extra$List$Extra$getAt, 4, model.skills_ok),
			$elm$core$Maybe$Just(true)) ? true : false;
		var ski_4_get = (!_Utils_eq(
			A2($elm_community$list_extra$List$Extra$getAt, 3, skills_ok),
			A2($elm_community$list_extra$List$Extra$getAt, 3, model.skills_ok))) ? true : false;
		var skills_cost = ski_4_get ? A2(
			$elm$core$List$map,
			function (a) {
				return a - 10;
			},
		...
		var ski_10_eff = _Utils_eq(
			A2($elm_community$list_extra$List$Extra$getAt, 9, model.skills_ok),
			$elm$core$Maybe$Just(true)) ? true : false;
		var red = $author$project$Check$cGameOver(model) ? model.redBricks : ((!_Utils_eq(model.nextBrick, $author$project$Outlooks$Red)) ? model.redBricks : ($author$project$Check$cUpBricks(model) ? (A2(
			$elm$core$List$member,
			$author$project$Calculate$upCoordinate(model),
			model.blueBricks) ? A2(
			...
			_List_fromArray(
				[
					$author$project$Calculate$upCoordinate(model)
				])) : model.redBricks) : ($author$project$Check$cLeftBricks(model) ? (A2(
			$elm$core$List$member,
			$author$project$Calculate$leftCoordinate(model),
			model.blueBricks) ? A2(
			$elm$core$List$append,
			...
			_List_fromArray(
				[
					$author$project$Calculate$leftCoordinate(model)
				])) : model.redBricks) : ($author$project$Check$cRightBricks(model) ? (A2(
			$elm$core$List$member,
			$author$project$Calculate$rightCoordinate(model),
			model.blueBricks) ? A2(
			$elm$core$List$append,
			...
			_List_fromArray(
				[
					$author$project$Calculate$rightCoordinate(model)
				])) : model.redBricks) : model.redBricks))));
		var pink = $author$project$Check$cGameOver(model) ? model.pinkBricks : ((!_Utils_eq(model.nextBrick, $author$project$Outlooks$Pink)) ? model.pinkBricks : ($author$project$Check$cUpBricks(model) ? (A2(
			$elm$core$List$member,
			$author$project$Calculate$upCoordinate(model),
			model.blueBricks) ? A2(
			$elm$core$List$append,
			...
			_List_fromArray(
				[
					$author$project$Calculate$upCoordinate(model)
				])) : model.pinkBricks) : ($author$project$Check$cLeftBricks(model) ? (A2(
			$elm$core$List$member,
			$author$project$Calculate$leftCoordinate(model),
			model.blueBricks) ? A2(
			$elm$core$List$append,
			...
			_List_fromArray(
				[
					$author$project$Calculate$leftCoordinate(model)
				])) : model.pinkBricks) : ($author$project$Check$cRightBricks(model) ? (A2(
			$elm$core$List$member,
			$author$project$Calculate$rightCoordinate(model),
			model.blueBricks) ? A2(
			$elm$core$List$append,
			...
			_List_fromArray(
				[
					$author$project$Calculate$rightCoordinate(model)
				])) : model.pinkBricks) : model.pinkBricks))));
		var max_life = ski_1_get ? 6 : model.max_life;
		var leaf = function () {
			if (($author$project$Check$cUpBricks(model) || ($author$project$Check$cLeftBricks(model) || $author$project$Check$cRightBricks(model))) && (!$author$project$Check$cDownPaddle(model))) {
				var next_leaf = ((A2($author$project$Check$cClearLine, model, 1) + A2($author$project$Check$cClearLine, model, 2)) + A2($author$project$Check$cClearLine, model, 3)) + A2($author$project$Check$cClearLine, model, 4);
				return next_leaf;
			} else {
				return model.leaf;
			}
		}();
		var isRed = (($author$project$Check$cUpBricks(model) && A2(
			$elm$core$List$member,
			$author$project$Calculate$upCoordinate(model),
			model.redBricks)) || (($author$project$Check$cLeftBricks(model) && A2(
			$elm$core$List$member,
			...
			$elm$core$List$member,
			$author$project$Calculate$rightCoordinate(model),
			model.redBricks)))) ? true : false;
		var isPink = (($author$project$Check$cUpBricks(model) && A2(
			$elm$core$List$member,
			$author$project$Calculate$upCoordinate(model),
			model.pinkBricks)) || (($author$project$Check$cLeftBricks(model) && A2(
			$elm$core$List$member,
			...
			$elm$core$List$member,
			$author$project$Calculate$rightCoordinate(model),
			model.pinkBricks)))) ? true : false;
		var life0 = ($author$project$Check$cGameOver(model) && (model.life > 0)) ? (isRed ? (ski_6_eff ? (model.life - 1) : (model.life - 2)) : (isPink ? model.life : (model.life - 1))) : (isRed ? (ski_6_eff ? model.life : (model.life - 1)) : (isPink ? ((_Utils_cmp(model.life + 1, model.max_life) < 1) ? (model.life + 1) : model.life) : model.life));
		var life1 = ski_7_eff ? A2(
			$elm$core$Basics$min,
			life0 + 2,
			A2($elm$core$Basics$max, life0, model.max_life) - 2) : life0;
		var life = ski_1_get ? (life1 + 1) : life1;
		var state = $author$project$Check$cWin(model) ? $author$project$Model$Stopped : (($author$project$Check$cGameOver(model) && (life > 0)) ? $author$project$Model$Paused : ((life <= 0) ? $author$project$Model$Stopped : $author$project$Model$Playing));
		var isCyan = (($author$project$Check$cUpBricks(model) && A2(
			$elm$core$List$member,
			$author$project$Calculate$upCoordinate(model),
			model.cyanBricks)) || (($author$project$Check$cLeftBricks(model) && A2(
			$elm$core$List$member,
			$author$project$Calculate$leftCoordinate(model),
			model.cyanBricks)) || ($author$project$Check$cRightBricks(model) && A2(
			$elm$core$List$member,
			$author$project$Calculate$rightCoordinate(model),
			model.cyanBricks)))) ? true : false;
		var exp0 = (($author$project$Check$cUpBricks(model) || ($author$project$Check$cLeftBricks(model) || $author$project$Check$cRightBricks(model))) && (!$author$project$Check$cDownPaddle(model))) ? (ski_5_eff ? ((model.combo > 0) ? ((((model.exp + 2) + ((model.combo - 1) * 3)) + model.leaf) + 1) : (((model.exp + 2) + model.leaf) + 1)) : ((model.combo > 0) ? (((model.exp + 2) + ((model.combo - 1) * 3)) + model.leaf) : ((model.exp + 2) + model.leaf))) : model.exp;
		...
		var empty0 = $author$project$Check$cGameOver(model) ? model.emptyBricks : ($author$project$Check$cUpBricks(model) ? ((A2(
			$elm$core$List$member,
			$author$project$Calculate$upCoordinate(model),
			model.cyanBricks) || (A2(
			$elm$core$List$member,
			...
			$elm$core$List$member,
			$author$project$Calculate$upCoordinate(model),
			model.blueBricks) && ski_10_eff)))) ? A2(
			$elm$core$List$append,
			model.emptyBricks,
			_List_fromArray(
				[
					$author$project$Calculate$upCoordinate(model)
				])) : model.emptyBricks) : ($author$project$Check$cLeftBricks(model) ? ((A2(
			$elm$core$List$member,
			$author$project$Calculate$leftCoordinate(model),
			model.cyanBricks) || (A2(
			$elm$core$List$member,
			...
			_List_fromArray(
				[
					$author$project$Calculate$leftCoordinate(model)
				])) : model.emptyBricks) : ($author$project$Check$cRightBricks(model) ? ((A2(
			$elm$core$List$member,
			$author$project$Calculate$rightCoordinate(model),
			model.cyanBricks) || (A2(
			$elm$core$List$member,
		...
		var empty = ski_9_eff ? ((!A2($elm$core$List$member, model.nextPoint, model.cyanBricks)) ? A2(
			$elm$core$List$append,
			empty0,
			_List_fromArray(
				[model.nextPoint])) : empty0) : empty0;
		var dyb0 = $author$project$Check$cGameOver(model) ? 0 : (($author$project$Check$cUpBricks(model) || ($author$project$Check$cUpPillar(model) || $author$project$Check$cDownPaddle(model))) ? (isCyan ? ((-1.05) * model.ball_vy) : (isRed ? ((-0.8) * model.ball_vy) : (isPink ? ((-1.2) * model.ball_vy) : ((-1) * model.ball_vy)))) : model.ball_vy);
		var dyb = ski_2_get ? (dyb0 * 0.5) : dyb0;
		var yb = $author$project$Check$cGameOver(model) ? 37.5 : ((_Utils_cmp(model.ball_y + (dt * dyb), 8 + $author$project$Object$r) < 0) ? (8 + $author$project$Object$r) : ((_Utils_cmp(model.ball_y + (dt * dyb), 45 - $author$project$Object$r) > 0) ? (45 - $author$project$Object$r) : (model.ball_y + (dt * dyb))));
		var dxp = $author$project$Check$cGameOver(model) ? 0 : (model.keys.left ? (ski_3_eff ? (-10.0) : (-7.0)) : (model.keys.right ? (ski_3_eff ? 10.0 : 7.0) : 0.0));
		var xp = $author$project$Check$cGameOver(model) ? 44 : (((model.pad_x + (dt * dxp)) > 78) ? 78 : (((model.pad_x + (dt * dxp)) < 10) ? 10 : (model.pad_x + (dt * dxp))));
		var dxb0 = $author$project$Check$cGameOver(model) ? 0 : (($author$project$Check$cLeftBricks(model) || ($author$project$Check$cLeftPillar(model) || ($author$project$Check$cRightBricks(model) || $author$project$Check$cRightPillar(model)))) ? (isCyan ? ((-1.05) * model.ball_vx) : (isRed ? ((-0.8) * model.ball_vx) : (isPink ? ((-1.2) * model.ball_vx) : ((-1) * model.ball_vx)))) : ($author$project$Check$cDownPaddle(model) ? (model.ball_vx + (0.05 * model.pad_vx)) : model.ball_vx));
		var dxb = ski_2_get ? (dxb0 * 0.5) : dxb0;
		var xb = $author$project$Check$cGameOver(model) ? 50 : ((_Utils_cmp(model.ball_x + (dt * dxb), 90 - $author$project$Object$r) > 0) ? (90 - $author$project$Object$r) : ((_Utils_cmp(model.ball_x + (dt * dxb), 10 + $author$project$Object$r) < 0) ? (10 + $author$project$Object$r) : (model.ball_x + (dt * dxb))));
		var cyan = $author$project$Check$cGameOver(model) ? model.cyanBricks : ((!_Utils_eq(model.nextBrick, $author$project$Outlooks$Cyan)) ? model.cyanBricks : ($author$project$Check$cUpBricks(model) ? (A2(
			$elm$core$List$member,
			$author$project$Calculate$upCoordinate(model),
			model.blueBricks) ? A2(
			$elm$core$List$append,
		...
		var combo = (($author$project$Check$cUpBricks(model) || ($author$project$Check$cLeftBricks(model) || $author$project$Check$cRightBricks(model))) && (!$author$project$Check$cDownPaddle(model))) ? (model.combo + 1) : ($author$project$Check$cDownPaddle(model) ? 0 : model.combo);
		return _Utils_update(
			model,
			{ball_vx: dxb, ball_vy: dyb, ball_x: xb, ball_y: yb, combo: combo, cyanBricks: cyan, emptyBricks: empty, exp: exp, leaf: leaf, life: life, max_life: max_life, pad_vx: dxp, pad_x: xp, pinkBricks: pink, redBricks: red, skills_cost: skills_cost, skills_ok: skills_ok, state: state});
	});
		...
		switch (msg.$) {
			...
			case 'Start':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{ball_vx: 3, ball_vy: -3, ball_x: 50, ball_y: 37.5, state: $author$project$Model$Playing}),
					$elm$core$Platform$Cmd$none);
			case 'Keep':
				return _Utils_Tuple2(
					_Utils_update(
...
var $author$project$Help$renderButton1 = A2(
	...
	_List_fromArray(
		[
			A2($elm$html$Html$Attributes$style, 'background', '#f8f4f4'),
			A2($elm$html$Html$Attributes$style, 'color', '#25a194'),
...
var $author$project$Help$renderDifficulty2 = A2(
	...
	_List_fromArray(
		[
			A2($elm$html$Html$Attributes$style, 'background', '#f8f4f4'),
			A2($elm$html$Html$Attributes$style, 'color', '#a19e32'),
			A2($elm$html$Html$Attributes$style, 'display', 'block'),
			A2($elm$html$Html$Attributes$style, 'height', '600x'),
...
var $author$project$Help$renderDifficulty3 = A2(
	...
	_List_fromArray(
		[
			A2($elm$html$Html$Attributes$style, 'background', '#f8f4f4'),
			A2($elm$html$Html$Attributes$style, 'color', '#a12b19'),
			A2($elm$html$Html$Attributes$style, 'display', 'block'),
			A2($elm$html$Html$Attributes$style, 'height', '600x'),
...
var $author$project$Help$renderInfo = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
			A2($elm$html$Html$Attributes$style, 'background', 'rgba(236, 240, 241, 0.85)'),
			A2($elm$html$Html$Attributes$style, 'color', '#090004'),
...
var $author$project$Help$view = function (model) {
	return _List_fromArray(
		[
			$author$project$Help$renderInfo,
...
var $author$project$Home$view = _List_fromArray(
	[
		$elm$html$Html$text('Welcome to game \"Save Oasis\"! '),
		A2(
		$elm$html$Html$ul,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$href('https://github.com/YuukiAS/VG100_Project1')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('Want to have a look at the source code?')
							]))
					]))
			]))
	]);
...
var $author$project$Outlooks$outBall = 'assets/main/ball.png';
var $author$project$Outlooks$outBkg = 'assets/main/bkp.png';
var $author$project$Outlooks$outInterface = 'assets/main/gameinter.png';
var $author$project$Outlooks$outPaddle = 'assets/main/pd.png';
...
var $author$project$Object$renderBackground = F4(
		...
		return A2(
			...
			_List_fromArray(
				[
					$elm$svg$Svg$Attributes$xlinkHref(pic),
					$elm$svg$Svg$Attributes$x(
					$elm$core$String$fromFloat(point.x - 1) + '%'),
					$elm$svg$Svg$Attributes$y(
					$elm$core$String$fromFloat(point.y - 1) + '%'),
					$elm$svg$Svg$Attributes$width(
...
var $author$project$Dashboard$renderDashboard = F3(
	function (point, wid, hei) {
		return A2(
			$elm$svg$Svg$rect,
			_List_fromArray(
				[
...
var $author$project$Message$Pause = {$: 'Pause'};
var $author$project$Message$Resume = {$: 'Resume'};
...
var $author$project$View$renderGameButton = function (model) {
	var _v0 = function () {
		...
		switch (_v1.$) {
			case 'Stopped':
				return _Utils_Tuple2('New game', $author$project$Message$Pause);
			case 'Playing':
				return _Utils_Tuple2(
					'Enjoy the game! You now have ' + ($elm$core$Debug$toString(model.life) + ' lives.'),
					$author$project$Message$Keep);
			default:
				return (model.life > 1) ? _Utils_Tuple2(
					'Continue, you still have ' + ($elm$core$Debug$toString(model.life) + ' lives.'),
					$author$project$Message$Start) : ((model.life === 1) ? _Utils_Tuple2(
					'Continue, you still have ' + ($elm$core$Debug$toString(model.life) + ' life.'),
					$author$project$Message$Start) : _Utils_Tuple2('Game Over. Click here to restart.', $author$project$Message$Resume));
		}
	}();
	var txt = _v0.a;
	var msg = _v0.b;
	return A2(
		...
		_List_fromArray(
			[
				...
				A2($elm$html$Html$Attributes$style, 'color', '#0ca101'),
				...
				A2($elm$html$Html$Attributes$style, 'left', '460px'),
				A2($elm$html$Html$Attributes$style, 'line-height', '60px'),
				A2($elm$html$Html$Attributes$style, 'outline', 'none'),
				A2($elm$html$Html$Attributes$style, 'padding', '0'),
				A2($elm$html$Html$Attributes$style, 'top', '700px'),
				A2($elm$html$Html$Attributes$style, 'position', 'absolute'),
...
var $author$project$View$renderMusic2 = function (model) {
	var music = function () {
		var _v0 = model.music;
		switch (_v0.$) {
			case 'Null':
...
var $author$project$Object$renderPaddle = F4(
	function (point, wid, hei, pic) {
		return A2(
			$elm$svg$Svg$image,
			_List_fromArray(
...
var $author$project$Outlooks$outOriginal = 'assets/main/o.png';
var $author$project$Object$renderBlueBrick = F5(
	function (num1, num2, point, wid, hei) {
		var b = point.y + ((hei + 0.175) * num2);
		var a = point.x + ((wid + 0.175) * num1);
		return A2(
			$elm$svg$Svg$image,
			_List_fromArray(
				[
					$elm$svg$Svg$Attributes$xlinkHref($author$project$Outlooks$outOriginal),
					$elm$svg$Svg$Attributes$x(
...
var $author$project$Outlooks$outHit = 'assets/main/n.png';
var $author$project$Object$renderCyanBrick = F5(
	function (num1, num2, point, wid, hei) {
		var b = point.y + ((hei + 0.175) * num2);
		var a = point.x + ((wid + 0.175) * num1);
		return A2(
			...
			_List_fromArray(
				[
					$elm$svg$Svg$Attributes$xlinkHref($author$project$Outlooks$outHit),
					$elm$svg$Svg$Attributes$x(
					$elm$core$String$fromFloat(a) + '%'),
					$elm$svg$Svg$Attributes$y(
					$elm$core$String$fromFloat(b) + '%'),
...
var $author$project$Outlooks$outIncrease = 'assets/main/acceleration.png';
var $author$project$Object$renderPinkBrick = F5(
	function (num1, num2, point, wid, hei) {
		var b = point.y + ((hei + 0.175) * num2);
		var a = point.x + ((wid + 0.175) * num1);
		return A2(
			...
			_List_fromArray(
				[
					$elm$svg$Svg$Attributes$xlinkHref($author$project$Outlooks$outIncrease),
					$elm$svg$Svg$Attributes$x(
					$elm$core$String$fromFloat(a) + '%'),
					$elm$svg$Svg$Attributes$y(
					$elm$core$String$fromFloat(b) + '%'),
...
var $author$project$Outlooks$outDecrease = 'assets/main/frozen.png';
var $author$project$Object$renderRedBrick = F5(
	function (num1, num2, point, wid, hei) {
		var b = point.y + ((hei + 0.175) * num2);
		var a = point.x + ((wid + 0.175) * num1);
		return A2(
			...
			_List_fromArray(
				[
					$elm$svg$Svg$Attributes$xlinkHref($author$project$Outlooks$outDecrease),
					$elm$svg$Svg$Attributes$x(
					$elm$core$String$fromFloat(a) + '%'),
					$elm$svg$Svg$Attributes$y(
					$elm$core$String$fromFloat(b) + '%'),
...
var $author$project$Object$renderABrick = F5(
	function (model, a, point, wid, hei) {
		return (A2($elm$core$List$member, a, model.cyanBricks) && (!A2($elm$core$List$member, a, model.emptyBricks))) ? _List_fromArray(
			[
				A5($author$project$Object$renderCyanBrick, a.b, a.a, point, wid, hei)
			]) : ((A2($elm$core$List$member, a, model.pinkBricks) && (!A2($elm$core$List$member, a, model.emptyBricks))) ? _List_fromArray(
			[
				A5($author$project$Object$renderPinkBrick, a.b, a.a, point, wid, hei)
			]) : ((A2($elm$core$List$member, a, model.redBricks) && (!A2($elm$core$List$member, a, model.emptyBricks))) ? _List_fromArray(
			[
				A5($author$project$Object$renderRedBrick, a.b, a.a, point, wid, hei)
			]) : (((!A2($elm$core$List$member, a, model.cyanBricks)) && ((!A2($elm$core$List$member, a, model.pinkBricks)) && ((!A2($elm$core$List$member, a, model.redBricks)) && (!A2($elm$core$List$member, a, model.emptyBricks))))) ? _List_fromArray(
			[
				A5($author$project$Object$renderBlueBrick, a.b, a.a, point, wid, hei)
			]) : _List_fromArray(
			[
...
var $author$project$Object$renderColumnBrick = F6(
	function (model, point, wid, hei, num1, num2) {
		return (num1 >= 0) ? A2(
			...
			A5(
				...
				wid,
				hei),
			A6($author$project$Object$renderColumnBrick, model, point, wid, hei, num1 - 1, num2)) : _List_Nil;
	});
var $author$project$Object$renderRowBrick = F6(
	function (model, point, wid, hei, num1, num2) {
		return (num2 >= 0) ? A2(
			$elm_community$list_extra$List$Extra$interweave,
			A6($author$project$Object$renderColumnBrick, model, point, wid, hei, num1, num2),
			A6($author$project$Object$renderRowBrick, model, point, wid, hei, num1, num2 - 1)) : _List_Nil;
	});
...
var $j_panasiuk$elm_ionicons$Ionicon$pause = $j_panasiuk$elm_ionicons$Ionicon$Internal$ps(
	_List_fromArray(
		['M224,435.8V76.1c0-6.7-5.4-12.1-12.2-12.1h-71.6c-6.8,0-12.2,5.4-12.2,12.1v359.7c0,6.7,5.4,12.2,12.2,12.2h71.6C218.6,448,224,442.6,224,435.8z', 'M371.8,64h-71.6c-6.7,0-12.2,5.4-12.2,12.1v359.7c0,6.7,5.4,12.2,12.2,12.2h71.6c6.7,0,12.2-5.4,12.2-12.2V76.1 C384,69.4,378.6,64,371.8,64z']));
...
var $j_panasiuk$elm_ionicons$Ionicon$volumeMedium = $j_panasiuk$elm_ionicons$Ionicon$Internal$g(
	_List_fromArray(
		[
			$j_panasiuk$elm_ionicons$Ionicon$Internal$pg1('270,407.7 270,104.4 175.3,192 71,192 71,320 175.3,320'),
			$j_panasiuk$elm_ionicons$Ionicon$Internal$p1('M326.3,355.6c20.5-27.8,32.8-62.3,32.8-99.6c0-37.4-12.3-71.8-32.8-99.6l-20.4,15.3c17.4,23.6,27.8,52.7,27.8,84.3 c0,31.6-10.4,60.7-27.8,84.3L326.3,355.6z'),
			$j_panasiuk$elm_ionicons$Ionicon$Internal$p1('M392.8,401.6c30-40.7,48-91,48-145.6s-18-104.9-48-145.6l-20.4,15.3c26.9,36.4,43,81.4,43,130.3c0,48.9-16.1,93.8-43,130.3 L392.8,401.6z')
		]));
var $j_panasiuk$elm_ionicons$Ionicon$volumeMute = $j_panasiuk$elm_ionicons$Ionicon$Internal$g(
	_List_fromArray(
		[
			$j_panasiuk$elm_ionicons$Ionicon$Internal$pg1('255.9,217 191,217 191,295 255.9,295 303,346.3 303,165.7'),
			$j_panasiuk$elm_ionicons$Ionicon$Internal$p1('M364.5,60.1c-0.4-0.2-0.7-0.4-1.1-0.6C331.5,42,294.9,32,256,32C132.3,32,32,132.3,32,256c0,84.3,46.6,157.6,115.4,195.9 c0.4,0.2,0.7,0.5,1.1,0.7C180.5,470,217.1,480,256,480c123.7,0,224-100.3,224-224C480,171.7,433.4,98.3,364.5,60.1z M393.9,355.4 L336,297.1v76.7l19.6,19.9c-28,20.3-62.3,32.7-99.5,32.7c-21.6,0-42.3-4.2-61.3-11.5c-6.5-2.5-12.9-5.3-19-8.6 c-53.6-28.7-90.1-85.2-90.1-150.3c0-37.2,12.4-71.4,32.7-99.4l35.3,35.4h76.7l-73.6-73.8c28-20.2,62.1-32.6,99.4-32.6 c21.6,0,42.2,4.2,61.3,11.5c6.1,2.4,12.2,5,17.9,8c54.2,28.5,91.3,85.3,91.3,150.8C426.5,293.3,414.2,327.4,393.9,355.4z')
		]));
var $author$project$Dashboard$renderSettings = function () {
	var volumeOn = A2(
		...
		_List_fromArray(
			[
				...
				$elm$svg$Svg$Attributes$y('0.8%')
			]),
		_List_fromArray(
			[
				A2($j_panasiuk$elm_ionicons$Ionicon$volumeMedium, 7, $author$project$Color$grey)
			]));
	var volumeOff = A2(
		$elm$svg$Svg$svg,
		_List_fromArray(
		...
		_List_fromArray(
			[
				A2($j_panasiuk$elm_ionicons$Ionicon$volumeMute, 7, $author$project$Color$grey)
			]));
	var refresh = A2(
		$elm$svg$Svg$svg,
		_List_fromArray(
	...
	var play = A2(
		...
		_List_fromArray(
			[
				$elm$svg$Svg$Attributes$x('59%'),
				$elm$svg$Svg$Attributes$y('2.8%')
			]),
		_List_fromArray(
			[
				A2($j_panasiuk$elm_ionicons$Ionicon$pause, 7, $author$project$Color$grey)
			]));
	var pause = A2(
		$elm$svg$Svg$svg,
		_List_fromArray(
	...
	var hype3 = A2(
		...
		_List_fromArray(
			[
				...
				$elm$svg$Svg$Events$onClick($author$project$Message$Pause)
			]),
		_List_Nil);
	var hype2 = A2(
		$elm$svg$Svg$rect,
	...
	return _List_fromArray(
		[refresh, home, help, hype1, hype2, hype3]);
}();
	...
	function (model, num) {
		...
		var sta = _Utils_eq(
			A2(
				...
				$elm$core$Basics$floor(num) - 1,
				model.skills_ok),
			$elm$core$Maybe$Just(true)) ? 'Yes' : 'No';
		return A2(
			$elm$svg$Svg$text_,
			_List_fromArray(
				[
	...
	return _List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$html$Html$text(
					$elm$core$String$fromInt(model.leaf) + ' Lines cleared')
				])) : A2(
			$elm$svg$Svg$text_,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					$elm$html$Html$text(
					$elm$core$String$fromInt(model.leaf) + ' Line cleared')
				])),
			clock,
			A2(
			$elm$svg$Svg$text_,
...
var $author$project$View$view = function (model) {
	return _List_fromArray(
		[
				...
				[
					...
					A2(
						...
						A2(
							...
							A2(
								...
								A6(
									...
									model,
									A2($author$project$Model$Point, 10, 8),
									6.5,
									2.5,
									4,
									11)),
						...
						_List_fromArray(
							[
								A3(
								$author$project$Dashboard$renderDashboard,
								A2($author$project$Model$Point, 40, 0.5),
								50,
								6),
								A4(
								$author$project$Object$renderBackground,
								A2($author$project$Model$Point, 0, 0),
								100,
								65,
								$author$project$Outlooks$outBkg),
								A4(
								$author$project$Object$renderBackground,
								A2($author$project$Model$Point, 9, 8),
								82,
								37,
								$author$project$Outlooks$outInterface),
								A4(
								$author$project$Object$renderBall,
								A2($author$project$Model$Point, model.ball_x, model.ball_y),
								2,
								2,
								$author$project$Outlooks$outBall),
								A4(
								$author$project$Object$renderPaddle,
								A2($author$project$Model$Point, model.pad_x, 40),
								12,
								1,
								$author$project$Outlooks$outPaddle)
							])))
				])),
			A2(
			$elm$html$Html$div,
			...
			_List_fromArray(
				[
					$author$project$View$renderMusic2(model)
				]))
		]);
};
