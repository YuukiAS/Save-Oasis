...
var $author$project$Update$updateBooklet = function (model) {
	var booklet = function () {
		var _v0 = model.booklet;
		switch (_v0.$) {
			case 'Initi':
				return $elm$core$List$head($author$project$Help$bookletList);
			case 'Previousone':
				return _Utils_eq(
					model.showingpage,
					A2(
						$elm$core$Maybe$withDefault,
						'a',
						$elm$core$List$head($author$project$Help$bookletList))) ? $elm$core$List$head(
					$elm$core$List$reverse($author$project$Help$bookletList)) : A2($author$project$Help$previousOne, model, $author$project$Help$bookletList);
			default:
				return _Utils_eq(
					model.showingpage,
					A2(
						...
						'a',
						$elm$core$List$head(
							$elm$core$List$reverse($author$project$Help$bookletList)))) ? $elm$core$List$head($author$project$Help$bookletList) : A2($author$project$Help$nextOne, model, $author$project$Help$bookletList);
		}
	}();
	return _Utils_update(
		model,
		{
			showingpage: A2($elm$core$Maybe$withDefault, 'a', booklet)
		});
};
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 'Alterpage':
				var booklet = msg.a;
				return _Utils_Tuple2(
					$author$project$Update$updateBooklet(model),
					$elm$core$Platform$Cmd$none);
			case 'Start':
				return _Utils_Tuple2(
					_Utils_update(
...
var $author$project$Help$renderInfo = A2(
	...
	_List_fromArray(
		[
			A2($elm$html$Html$Attributes$style, 'background', '#1d1d1d'),
...
var $author$project$Dashboard$renderSettings = function () {
	...
	var hype3 = A2(
		...
		_List_fromArray(
			[
				...
				$elm$svg$Svg$Events$onClick($author$project$Message$Start)
			]),
		_List_Nil);
	var hype2 = A2(
		$elm$svg$Svg$rect,
	...
	return _List_fromArray(
		[refresh, home, hype1, hype2, hype3, help]);
}();
